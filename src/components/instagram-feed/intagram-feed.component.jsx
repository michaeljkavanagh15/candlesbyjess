  ...
  return (
    <div>
      <blockquote
        ...
        datainstgrmpermalink="https://www.instagram.com/candles_by_jesss/?utm_source=ig_embed&amp;utm_campaign=loading"
      ...
      >
        <div style={{padding:"16px"}}>
          {" "}
          <a
            href="https://www.instagram.com/candles_by_jesss/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          >
            ...
            <div style={{display: 'flex', flexDirection: 'row', marginBottom: '14px', alignItems: 'center'}}>
              <div>
                ...
                <div style={{backgroundColor: '#F4F4F4', height: '12.5px', transform: 'rotate(-45deg) translateX(3px) translateY(1px)', width: '12.5px', flexGrow: '0', marginRight: '14px', margiLeft: '2px'}}></div>{" "}
            ...
            <div style={{display: 'flex', flexDirection: 'column', flexGrow: '1', justifyContent: 'center', marginBottom: '24px'}}>
              {" "}
              <div style={{backgroundColor:' #F4F4F4', borderRadius: '4px', flexRow: '0', height: '14px', marginBottom: '6px', width: '224px'}}></div>{" "}
              <div style={{backgroundColor:' #F4F4F4', borderRadius: '4px', flexRow: '0', height: '14px', width: '144px'}}></div>
            </div>
          </a>
